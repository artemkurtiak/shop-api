...
export class CreateUserEntity1677014144029 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_userrolewithsuperadmin_enum" AS ENUM('OWNER', 'MANAGER', 'CONSUMER', 'SUPER_ADMIN')`);
        await queryRunner.query(`CREATE TYPE "public"."users_userstatus_enum" AS ENUM('PENDING', 'ACTIVE', 'BLOCKED')`);
